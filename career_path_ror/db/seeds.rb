...
if University.count <= 0
  ...
  University.create(name: "Trường ĐH Công nghiệp TP.HCM", description: "", website: "http://www.iuh.edu.vn/", image_url: "", careers: [1, 2, 3, 4, 5, 6, 7, 8, 27, 28], r_ranking: 1, i_ranking: 1, a_ranking: 1, s_ranking: 1, e_ranking: 1, c_ranking: 1)
